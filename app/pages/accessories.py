...
def accessories() -> rx.Component:
    return rx.el.div(
        ...
        rx.el.main(
            rx.el.div(
                rx.el.h1("Accesorios", class_name="text-4xl font-bold text-gray-900"),
                rx.el.p(
                    "Equipa tu dispositivo con los mejores accesorios.",
                    class_name="text-lg text-gray-600 mt-2",
                ),
                class_name="text-center py-16 bg-blue-50 rounded-xl",
            ),
            rx.el.div(
                rx.el.div(
                    rx.el.input(
                        ...
                        class_name="w-full md:w-1/3 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none",
                    ),
                    rx.el.select(
                        ...
                        class_name="p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none",
                    ),
                    rx.el.div(
                        rx.el.input(
                            type="number",
        ...
        on_mount=lambda: MainState.set_filter_category("accessory"),
    )